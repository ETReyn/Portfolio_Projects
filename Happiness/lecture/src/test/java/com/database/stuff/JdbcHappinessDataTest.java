...
public class JdbcHappinessDataTest extends BaseDaoTests{
    ...
    private String table = "happinessTesting";
    ...
    {
        HappinessData result = sut.getCountryData(1, table);
    ...
    {
        HappinessData result = sut.getCountryData(-10, table);
    ...
    {
        List<HappinessData> result = sut.getAllReports(table);
    ...
    public void create_happiness_record_returns_correct_record()
    {
        ...
        HappinessData result = sut.createHappinessData(newData, table);
    ...
    {
        sut.deleteData(1, table);
        Assert.assertNull(sut.getCountryData(1, table));
    }
    ...
    public void update_reports()
    {
        ...
        sut.updateData(result, table);
        HappinessData after = sut.getCountryData(result.getId(), table);
